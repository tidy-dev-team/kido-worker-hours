  ...
  const monthRows=months.map(mk=>{
    ...
    return `<tr class="month-row" data-month="${mk}" style="border-bottom:1px solid var(--border)">
      ...
      <td class="month-name-cell" style="padding:10px 14px">
        ...
        ${isCurrent?'<span class="badge-current" style="font-size:10px;background:var(--primary);color:#fff;padding:2px 7px;border-radius:10px;margin-right:7px;vertical-align:middle">נוכחי</span>':''}
      </td>
      ...
      <td class="month-actions-cell" style="padding:10px 14px;text-align:center">
        <div style="display:flex;align-items:center;justify-content:center;gap:6px">
          <button class="btn btn-s btn-sm btn-export-month" title="ייצוא חודש זה לאקסל" style="gap:5px" onclick="exportMonthsToExcel('${mk}')">
